---
pageType: doc
title: Writing a Bundler - Part 1
sidebar: false
date: 2024-01-15
---
import ArticleHero from '../../components/article-hero/article-hero.tsx'
import EmbedHtml from '../../components/embed-html/embed-html.tsx'
...
<ArticleHero 
  src={heroImage} 
  alt="Hero image of transformers cartoon"
  subtitle="Transformers, JavaScript in disguise"
/>
...
<img src="./assets/over-90000.png" loading="lazy" className="xxs"/>
...
<EmbedHtml loading="lazy" src={fetch('./assets/screenfetch.html')} />
...
<img src="./assets/bench-baseline-parcel-x16.png" loading="lazy" className="xxl" />
...
<img src="./assets/build-time-vs-threads-parcel.png" loading="lazy" className="xxl" />
...
<img src="./assets/single-threaded-performance.png" loading="lazy" className="xxl" />
...
<img src="./assets/multi-threaded-bench.png" loading="lazy" className="xxl" />
...
<img src="./assets/hypersonic-threads-comparison.png" loading="lazy" className="xxl" />
